...
const port = 3021; //defined port for this web-service
...
/**
 * The generateFlowAlarm generates a new Alarm of Type "CombustionFlowAlarm". It takes the
...
function mqttSendData(flow) {
    ...
    client.publish('OutletCombustion', message)
}