...
const port = 3012; //defined port for this web-service
...
/**
 * The generateFlowAlarm generates a new Alarm of Type "FuelFlowAlarm". It takes the
...
function generateFlowAlarm(flow) {
    ...
    const alarm = {type: "FuelFlowAlarm", timestamp: Math.floor(millis / 1000), argument: flow + " L/m"};
...
function mqttSendData(flow) {
    ...
    client.publish('InletFuel', message)
}