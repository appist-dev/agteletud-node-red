...
const port = 3011; //defined port for this web-service
...
/**
 * The generateFlowAlarm generates a new Alarm of Type "AirFlowAlarm". It takes the
...
function mqttSendData(flow) {
    ...
    client.publish('InletAir', message)
}