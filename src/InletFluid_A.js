...
const port = 3013; //defined port for this web-service
...
/**
 * The generateFlowAlarm generates a new Alarm of Type "Fluid_AFlowAlarm". It takes the
...
function mqttSendData(flow) {
    ...
    client.publish('InletFluid_A', message)
}